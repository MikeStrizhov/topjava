...
public class MealsUtil {
    ...
    public static final int CALORIES_FOR_EXCEEDED = 2000;
    ...
    public static List<MealWithExceed> getMealsWithExeeded(List<Meal> meals, int caloriesPerDay){
        return getFilteredWithExceeded(meals, LocalTime.of(0,0,0), LocalTime.MAX, caloriesPerDay);
    }
